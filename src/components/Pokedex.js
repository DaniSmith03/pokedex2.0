        ...
        <Box maxHeight='80vh' className={classes.pokemonBox}>
          ...
          <Box className={classes.pokeInfo}>
            ...
            <Typography fontSize='20px'>
              Types: {capitalizeFirst(types.join(', '))}
            </Typography>
            <Typography fontSize='20px'>
              Abilities: {capitalizeFirst(abilities.join(', '))}
            </Typography>
          </Box>
        </Box>
      </React.Fragment>
      ...
      >
        <Box maxWidth={150} className={classes.cardBox}>
          <Card
            ...
            onClick={() => setPokeDetails(renderDetails(pokemonId))}
          >
            <CardMedia
          ...
          <Typography className={classes.pokeName}>{`${capitalizeFirst(
            name
          )}`}</Typography>
        </Box>
      </Grid>
              ...
              <Grid container spacing={2}>
                {Object.keys(pokeData).map(
                  (pokemonId) =>
                    ...
                    evalTypes(pokeData[pokemonId].types) === true &&
                    getCard(pokemonId)
                )}
              </Grid>
            ) : (
